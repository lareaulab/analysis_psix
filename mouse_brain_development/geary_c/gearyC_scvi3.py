...
tiklova_pca = pd.read_csv('~/analysis_psix/scvi_runs/tiklova_scvi3_rd.tab', sep='\t', index_col=0)
...
pgamma_tiklova.to_csv('tiklova_GearyC_scvi3.tab', sep='\t', header=True, index=True)
