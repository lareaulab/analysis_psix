...
tiklova_pca = pd.read_csv('~/analysis_psix/scvi_runs/tiklova_scvi5_batch_rd.tab', sep='\t', index_col=0)
...
pgamma_tiklova.to_csv('tiklova_GearyC_scvi5_batch.tab', sep='\t', header=True, index=True)
